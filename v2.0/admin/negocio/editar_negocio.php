 <?php 
  ...
  $afip = filter_var($_POST['afip'], FILTER_SANITIZE_STRING);
    mysqli_real_escape_string($conn , $afip);
    
    
   $imagenAfip = filter_var($_POST['imagenAfip'], FILTER_SANITIZE_STRING);
    mysqli_real_escape_string($conn , $imagenAfip);
    
   
  $mediosPago = filter_var($_POST['mediosPago'], FILTER_SANITIZE_STRING);
 mysqli_real_escape_string($conn , $mediosPago);  
...
//------------------------------------------------------------------------------//
  $sql = "UPDATE `negocio` SET nombre= '$nombre' , descripcion = '$descripcion' , alert = '$alert' , celular = '$celular' , email = '$email' , whatsapp = '$whatsapp' , whatsapp2 = '$whatsapp2' , facebook = '$facebook' , instagram = '$instagram' , telegram = '$telegram' , registro='$afip' ,imagenRegistro='$imagenAfip', mediosPago='$mediosPago', info = '$info' WHERE 1";
