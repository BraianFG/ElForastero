...
<div id="editar__mensajes_<?php echo $mostrar_productosp1['0'] ?>" uk-modal>
    <div class="uk-modal-dialog">
       ...
       <div class="uk-modal-body" id="productos" uk-overflow-auto>
        ...
        <input  name="id" type="hidden" placeholder="" value="<?php echo $mostrar_productosp1[0]?>">
  
        <input  name="UsuarioID" type="hidden" placeholder="" value="<?php echo $mostrar_productosp1[1]?>" disabled>
...
<div id="eliminar_<?php echo $mostrar_productosp1[0] ?>" uk-modal>
    ...
    <h3 class="uk-text-center">¿Desea eliminar los mensajes de <?php echo $mostrar_productosp1[2] ?> ?</h3>
      <button class="uk-modal-close-default" type="button" uk-close></button>
      <div class="eliminar">
