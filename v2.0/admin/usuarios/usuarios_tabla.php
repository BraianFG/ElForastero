...
<script>
   function verUsuarios() {
        ...
        $.post("paginacion/paginacion-usuarios.php", { numero: numero}, function(response) {
...
<div id="editar__usuarios_<?php echo $mostrar_productosp1[0] ?>" uk-modal>
    <div class="uk-modal-dialog" id="<?php echo $mostrar_productosp1[0] ?>">
        ...
        <label class="datos">Número de usuario</label>
         <input  name="id" min="1" type="hidden" placeholder="Número de usuario" value="<?php echo $mostrar_productosp1[0] ?>" >
