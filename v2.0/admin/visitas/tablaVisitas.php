...
<script>
  ...
  new Chart(ctx, {
    ...
    data: {
      labels: [<?php $productosp1 = "SELECT `pais` , COUNT(`num`) FROM `visitas` GROUP BY `pais` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
      ...
      datasets: [{
        ...
        data: [ <?php $productosp1 = "SELECT `pais` , COUNT(`num`) FROM `visitas` GROUP BY `pais` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
...
<script>
  ...
  new Chart(ctx2, {
    ...
    data: {
      labels: [<?php $productosp1 = "SELECT `ciudad` , COUNT(`num`) FROM `visitas` GROUP BY `ciudad` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
      ...
      datasets: [{
        ...
        data: [ <?php $productosp1 = "SELECT `ciudad` , COUNT(`num`) FROM `visitas` GROUP BY `ciudad` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
          $result3 = mysqli_query($conn,$productosp1);  while($mostrar_productosp1 = mysqli_fetch_array($result3)){?>'<?php  echo $mostrar_productosp1['COUNT(`num`)'] ?>' <?php echo ' , '?> <?php }?> '<?php echo '.'?>'],
...
<script>
  ...
  new Chart(ctx3, {
    ...
    data: {
      labels: [<?php $productosp1 = "SELECT `pagina` , COUNT(`num`) FROM `visitas` GROUP BY `pagina` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
      ...
      datasets: [{
        ...
        data: [ <?php $productosp1 = "SELECT `pagina` , COUNT(`num`) FROM `visitas` GROUP BY `pagina` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
          $result3 = mysqli_query($conn,$productosp1);  while($mostrar_productosp1 = mysqli_fetch_array($result3)){?>'<?php  echo $mostrar_productosp1['COUNT(`num`)'] ?>' <?php echo ' , '?> <?php }?> '<?php echo '.'?>'],
...
<script>
  ...
  new Chart(ctx4, {
    ...
    data: {
      labels: [<?php $productosp1 = "SELECT `sistema_operativo` , COUNT(`num`) FROM `visitas` GROUP BY `sistema_operativo` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
          $result3 = mysqli_query($conn,$productosp1);  while($mostrar_productosp1 = mysqli_fetch_array($result3)){?>'<?php  echo $mostrar_productosp1['sistema_operativo'] ?>' <?php echo ' , '?> <?php }?>],
 
      datasets: [{
        label: 'Sistema operativo usado',
        data: [ <?php $productosp1 = "SELECT `sistema_operativo` , COUNT(`num`) FROM `visitas` GROUP BY `sistema_operativo` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
          $result3 = mysqli_query($conn,$productosp1);  while($mostrar_productosp1 = mysqli_fetch_array($result3)){?>'<?php  echo $mostrar_productosp1['COUNT(`num`)'] ?>' <?php echo ' , '?> <?php }?> '<?php echo '.'?>'],
...
<script>
  ...
  new Chart(ctx5, {
    ...
    data: {
      labels: [<?php $productosp1 = "SELECT `referido` , COUNT(`num`) FROM `visitas` GROUP BY `referido` ORDER BY COUNT(`num`) DESC LIMIT 5;" ;     
      ...
      datasets: [{
        ...
        data: [ <?php $productosp1 = "SELECT `referido` , COUNT(`num`) FROM `visitas` GROUP BY `referido` ORDER BY COUNT(`num`) DESC LIMIT 5;" ;     
          $result3 = mysqli_query($conn,$productosp1);  while($mostrar_productosp1 = mysqli_fetch_array($result3)){?>'<?php  echo $mostrar_productosp1['COUNT(`num`)'] ?>' <?php echo ' , '?> <?php }?> '<?php echo '.'?>'],
...
<script>
  ...
  new Chart(ctx6, {
    ...
    data: {
      labels: [<?php $productosp1 = "SELECT `ip` , COUNT(`num`) FROM `visitas` GROUP BY `ip` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
      ...
      datasets: [{
        ...
        data: [ <?php $productosp1 = "SELECT `ip` , COUNT(`num`) FROM `visitas` GROUP BY `ip` ORDER BY COUNT(`num`) DESC LIMIT 10;" ;     
          $result3 = mysqli_query($conn,$productosp1);  while($mostrar_productosp1 = mysqli_fetch_array($result3)){?>'<?php  echo $mostrar_productosp1['COUNT(`num`)'] ?>' <?php echo ' , '?> <?php }?> '<?php echo '.'?>'],
