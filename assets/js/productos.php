...
function actualizarCarrito() {
	...
	$.post( "../assets/php/total.php", {total: total});
	// ------------------------------------------------------------------------
...
$("#BorrarCarrito").click(function () {
	...
	actualizarCarrito();
	$.post( "../assets/php/productos/eliminar.php", { usuarioID:<?php echo $_SESSION["id"]?> } );
});
...
function agregarCarrito(id, nombre, cantidad, precio) {
	...
	actualizarCarrito();
	   $.post( "../assets/php/productos/agregar.php", { productoID: id, cantidad: cantidad } );
  }
</script>
