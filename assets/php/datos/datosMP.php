...
/////////////////////////////
  $negocio = "SELECT * FROM totalPedido WHERE UsuarioID = '$id'" ;     
         $resultados = mysqli_query($conn,$negocio);          
            while($negocio= mysqli_fetch_array($resultados)){
    ///////////////////////////
  $negocio2 = "SELECT * FROM MercadoPago" ;     
         $resultados2 = mysqli_query($conn,$negocio2);          
            while($negocio2= mysqli_fetch_array($resultados2)){            
...
/////////////////////////////
$comision = $negocio['total'] * $negocio2['comision'] /100;
$header = array("", "");
$data2 = array(
	array("Subtotal",$negocio['total']),
	array("Comision Mercado Pago", $negocio['total'] * $negocio2['comision'] /100),
	array("Total",$negocio['total'] + $comision),
);
    // Column widths
    $w2 = array(40, 40);
    // Header
