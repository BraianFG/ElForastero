...
?>  
 ...
 <li id="item-3">
       <section class="uk-text-center uk-container uk-container-xlarge uk-margin-bottom ">
           
          <h2 class="titulo">¿Cómo desea pagar?</h3>
          <p>Seleccione alguna modalidad de pago</p>
       </section>
<div class="uk-container uk-container-xlarge pagos">   
     <div class="uk-child-width-1-3@m uk-grid-small uk-grid-match" uk-grid>
            ...
            <div class="pagar">
                <a  class="button primary pagar" href="comprar1" >Elegír esta opción <i class="fa-solid fa-circle-arrow-right"></i></a>
            </div>
            </div>
            <div class="uk-card uk-card-default uk-card-body">
                ...
                <a class="button primary" href="comprar2" style="margin-top:5.3em">Elegír esta opción <i class="fa-solid fa-circle-arrow-right"></i></a>
            </div>
            <div class="uk-card uk-card-default uk-card-body">
