...
<div id="editar__mensajes_<?php echo $mostrar_productosp1['0'] ?>" uk-modal>
    <div class="uk-modal-dialog">
       ...
       <div class="uk-modal-body" id="productos" uk-overflow-auto>
        ...
        <input  name="UsuarioID" type="number" placeholder="" value="<?php echo $mostrar_productosp1[0]?>" required >

       <label class="datos"><i class="fas fa-user"></i>Nombre/s</label>
        <input  name="nombre" type="text" placeholder="" value="<?php echo $mostrar_productosp1[1],  $mostrar_productosp1[2]?>" disabled >
        
        <label class="datos"><i class="fas fa-user"></i>Apellido/s</label> 
        <input  name="apellido" type="text" placeholder="" value="<?php echo $mostrar_productosp1[2] ?>" disabled >
    

       <label class="datos"><i class="fas fa-comment-alt"></i> Mensaje del cliente</label>
        <textarea class="descripcion"><?php echo $mostrar_productosp1[3]?></textarea disabled>
...
<div id="eliminar_<?php echo $mostrar_productosp1[0] ?>" uk-modal>
    ...
    <h3 class="uk-text-center">¿Desea eliminar este mensaje?</h3>
      <button class="uk-modal-close-default" type="button" uk-close></button>
      <div class="eliminar">
            <a class="button primary uk-modal-close" onclick="eliminar_mensajes((UsuarioID=<?php echo $mostrar_productosp1['0'] ?>)) ">Si <i class="fas fa-check"></i></a>
...
<script>
    function eliminar_mensajes(UsuarioID){
       $.post( "usuarios/eliminar__mensajes.php", { UsuarioID : UsuarioID} );
