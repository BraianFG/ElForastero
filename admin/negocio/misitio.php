        ...
        <div class="uk-modal-body" uk-overflow-auto>
          <form method="post" action="negocio/editar_misitio.php/"  enctype="multipart/form-data">
              <label class="datos"><i class="far fa-edit"></i>Titulo</label>
                ...
                <label for="dominio" class="datos"><i class="fa-solid fa-folder-tree"></i> Dominio (EJ. https://misitio.com)</label>
                <input type="text" value="<?php echo $mostrar['dominio'] ?>" name="dominio">
                ...
                <label class="datos"> <i class="fa-solid fa-upload"></i>Suba la aplicacíón de su tienda (sólo para Android)</label>
                <input type="file" accept="/* "  name="app" >
        </div>
